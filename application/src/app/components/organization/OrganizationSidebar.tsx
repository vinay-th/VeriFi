...
const OrganizationSidebar = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="overflow-hidden flex flex-col justify-center items-center h-screen bg-[rgb(104,93,201)] w-[13.5rem] py-9 px-6 sticky top-0 select-none">
      ...
      <Link
        className="w-40 h-12 rounded-lg cursor-pointer p-3 hover:bg-[rgb(173,166,234)] flex flex-row text-white"
        href="/"
      >
